...
public class C03_FarkliWebTable extends TestBase {
    ...
    public void webTableTest(){
        ...
        WebElement tumBodyElementi= driver.findElement(By.xpath("//div[@class='rt-table']"));
        ...
        List<WebElement> ikiciSatirElementleriList=
                driver.findElements(By.xpath("(//*[@*='rowgroup'])[5]//*[@*='gridcell']"));
        System.out.println("Tablodaki Sutun Sayisi :" + ikiciSatirElementleriList.size());

        // 8. Tablodaki 3.kolonu yazdirin
        List<WebElement> ucuncuKolonElementleri=driver.findElements(By.xpath("(//*[@*='rowgroup'])//*[@*='gridcell'][3]"));
        ...
        /*
         ...
         ((//*[@*='rowgroup'])[?]//*[@*='gridcell'][1]
         */
        String dinamikIsimLoceti;
        String dinamikMaasLocati;
        String isim;
        String maas;

        for (int i = 1; i <=satirElementleriListesi.size() ; i++) {
            dinamikIsimLoceti="(//*[@*='rowgroup'])[" + i + "]//*[@*='gridcell'][1]";
            dinamikMaasLocati="(//*[@*='rowgroup'])[" + i + "]//*[@*='gridcell'][5]";

            isim = driver.findElement(By.xpath(dinamikIsimLoceti)).getText();
        ...
        //((//*[@role='rowgroup'])[3]//*[@role='gridcell'])[5]
        //       satır                          sutun
    ...
    public void datayiYazdir(int satirNo, int sutunNo){
        String dinamikXpath="((//*[@*='rowgroup'])["+ satirNo+
