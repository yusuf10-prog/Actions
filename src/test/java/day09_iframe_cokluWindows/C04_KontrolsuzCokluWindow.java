...
public class C04_KontrolsuzCokluWindow extends TestBase {
    ...
    public void cokluPencereTesti(){
        ...
        /* BURASİ BENİM YAPTIĞIM:
        WebElement textYazisiGetir= driver.findElement(By.xpath("//div[@id='content']"));
        String gelenTextYazisi=textYazisiGetir.getText();
        String textYazisiOlmasiGereken="Opening a new window";

        Assert.assertTrue(gelenTextYazisi.contains(textYazisiOlmasiGereken));
        ...
        // artik 2. sayfanin whd'nin degerini bildigimiz icin, ikinci sayfaya gecis yapabiliriz.
