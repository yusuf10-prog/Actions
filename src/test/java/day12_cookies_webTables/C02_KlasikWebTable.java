...
public class C02_KlasikWebTable extends TestBase {
    ...
    public void test01(){
        ...
        // Sayfanın en altına gitme işlemini yapar.
        ...
        System.out.println("========= Satirlarin Sirasiyla Yazildigi Alan =========");
        ...
        //6. Web table'daki sutun sayisinin 13 oldugunu test edin.
        List<WebElement> birinciSatirDataList=driver.findElements(By.xpath("//tr[1]/tr"));

        int expectedSutunSayisi=13;
        int actualSutunSayisi=birinciSatirDataList.size();

        System.out.println(actualSutunSayisi);
